        ...
        <>
            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-4 border-b border-slate-100 shrink-0 relative">
                    <div className={cn("flex items-center gap-3 transition-all", collapsed && "w-full justify-center")}>
                        {!collapsed ? (
                            <>
                                <img src="/logo_meereo.png" alt="Meereo" className="h-10 sm:h-12 md:h-14 w-auto" />
                                <img src="/ruzibiza.jpeg" alt="Ruzibiza" className="h-10 sm:h-12 md:h-14 w-auto" />
                            </>
                        ) : (
