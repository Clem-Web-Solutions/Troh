...
const CLIENTS = [
    { id: 1, name: 'M. et Mme. Dubois', email: 'dubois.famille@email.com', phone: '06 12 34 56 78', projects: 1, status: 'active' },
    { id: 2, name: 'SCI Horizon', email: 'contact@sci-horizon.immo', phone: '01 98 76 54 32', projects: 2, status: 'active' },
    { id: 3, name: 'M. Leroy', email: 'jean.leroy@email.com', phone: '06 87 65 43 21', projects: 1, status: 'lead' },
];
